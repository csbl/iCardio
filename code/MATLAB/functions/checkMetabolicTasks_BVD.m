function [taskReport essentialRxns taskStructure CarryingRxns] = checkMetabolicTasksRxns(model,inputFile,printOutput,printOnlyFailed,getEssential,taskStructure)
...
%             end
            ...
            % Add in reactions if a reaction is specified
            % Shouldn't matter if the reaction is already in the model,
            % just add the reaction again with the new constraints
        end
    end
