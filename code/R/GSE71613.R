...
dir <- "F:/Transcriptomics/kallisto/outputs/GSE71613"

# Check for all files in the directory to ensure they are present 
list.files(dir)

# Read in meta data table
metadata <- read.xlsx(file.path("F:/Transcriptomics/kallisto/outputs/GSE71613/metadata.xlsx"), header = TRUE, sheetIndex =1) %>% 
...
write.table(all.results, file = "C:/Users/bvd5nq/Documents/R scripts/Cardiomyocyte Model/GSEdata/GSE71613_failure_DEGs.csv", 
...
write.table(model.genes.data, file = "C:/Users/bvd5nq/Documents/R scripts/Cardiomyocyte Model/GSEdata/GSE71613_failure_model_DEGs.csv", 
            col.names = TRUE, row.names = FALSE, sep = ",")
